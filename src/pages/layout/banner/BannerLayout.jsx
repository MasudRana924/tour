...
const BannerLayout = () => {
    return (
        ...
        <p className='experience-title text-center mt-4'>Experience the thrill of exploring the worlds most fascinating destinations with</p>
        <p className='experience-title text-center'>our expertly curated travel packages. </p>

        <div className='banner-bottom-section border mt-12'>
